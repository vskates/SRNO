...
**Research memo, 25 August 2026.**  Статус: новая проверяемая гипотеза и design документа, а не заявление о достигнутом SOTA. По прямому указанию существующий репозиторий, `ICLR_GRASP_IDEA_RESEARCH.md` и другие внутренние Markdown-идеи не читались. Поэтому novelty-аудит ниже проведён по внешней литературе; логически несовместимое требование «гарантировать непересечение с непрочитанными внутренними заметками» проверить невозможно.
