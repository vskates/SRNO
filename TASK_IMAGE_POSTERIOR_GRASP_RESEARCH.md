...
Эта записка создана без чтения `ICLR_GRASP_IDEA_RESEARCH.md`, других файлов репозитория и локальных markdown-описаний сегодняшних occlusion ideas. Поэтому она не делает ложного утверждения, что overlap с неизвестным содержимым формально проверен; она лишь соблюдает требование независимой разработки. Внешний literature novelty audit проведён по доступным первичным источникам до 25 августа 2026 года.
